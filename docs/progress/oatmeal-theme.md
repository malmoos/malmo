...
- **Home / Settings are recolor-only.** They pick up the olive palette + Inter through the token remap, but their *composition* was not restructured to the theme in this PR (scope was bounded to the auth surfaces). Full restructure tracked as a follow-up issue.
...
1. **Restructure Home + Settings to the Oatmeal composition** (follow-up issue) — bring the calm-launcher home grid and Settings panels onto the theme's component shapes, not just its colors.

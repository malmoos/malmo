...
- **Every unit of work gets a progress entry.** Add a `docs/progress/<slug>.md` (ADR-style, kebab-slug, not numbered) that records **what was done** and **what's next**, following the template in `docs/progress/0001-walking-skeleton.md`. Update the entry's "what's next" as follow-ups land.
